...
public final class Utils {
    ...
    static boolean equals(Type a2, Type b) {
        ...
        if (a2 instanceof ParameterizedType) {
            ...
            return equals(((GenericArrayType) a2).getGenericComponentType(), ((GenericArrayType) b).getGenericComponentType());
            ...
            return true;
        } else if (!(a2 instanceof TypeVariable) || !(b instanceof TypeVariable)) {
            return false;
        } else {
