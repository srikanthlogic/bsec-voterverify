...
public class Nysiis implements StringEncoder {
    ...
    private static char[] transcodeRemaining(char c, char c2, char c3, char c4) {
        return (c2 == 'E' && c3 == 'V') ? CHARS_AF : isVowel(c2) ? CHARS_A : c2 == 'Q' ? CHARS_G : c2 == 'Z' ? CHARS_S : c2 == 'M' ? CHARS_N : c2 == 'K' ? c3 == 'N' ? CHARS_NN : CHARS_C : (c2 == 'S' && c3 == 'C' && c4 == 'H') ? CHARS_SSS : (c2 == 'P' && c3 == 'H') ? CHARS_FF : (c2 != 'H' || (isVowel(c) && isVowel(c3))) ? (c2 != 'W' || !isVowel(c)) ? new char[]{c2} : new char[]{c} : new char[]{c};
    }
