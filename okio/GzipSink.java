...
public final class GzipSink implements Sink {
    ...
    /* JADX INFO: Multiple debug info for r0v6 okio.Buffer: [D('this_$iv' okio.RealBufferedSink), D('$this$apply' okio.Buffer)] */
    ...
    /* JADX INFO: Multiple debug info for r3v4 int: [D('segmentLength' int), D('b$iv' int)] */
    ...
    public final Deflater m1167deprecated_deflater() {
        return this.deflater;
    }
}
