        ...
        return new OutputStream() { // from class: okio.RealBufferedSink$outputStream$1
            ...
            public void write(int b) {
                if (!RealBufferedSink.this.closed) {
                    RealBufferedSink.this.bufferField.writeByte((byte) b);
