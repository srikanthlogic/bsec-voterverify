...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.Fragment);
        if (fname == null) {
            fname = a2.getString(R.styleable.Fragment_android_name);
        }
        int id = a2.getResourceId(R.styleable.Fragment_android_id, -1);
        String tag = a2.getString(R.styleable.Fragment_android_tag);
        a2.recycle();
