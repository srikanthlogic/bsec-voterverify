...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.FragmentContainerView);
            if (name == null) {
                name = a2.getString(R.styleable.FragmentContainerView_android_name);
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, FragmentManager fm) {
        ...
        String name = attrs.getClassAttribute();
        TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.FragmentContainerView);
        name = name == null ? a2.getString(R.styleable.FragmentContainerView_android_name) : name;
        String tag = a2.getString(R.styleable.FragmentContainerView_android_tag);
        a2.recycle();
        int id = getId();
