...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    private Drawable getThemeUpIndicator() {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            TypedArray a2 = context.obtainStyledAttributes(null, THEME_ATTRS, 16843470, 0);
            Drawable result = a2.getDrawable(0);
            a2.recycle();
            return result;
        }
        TypedArray a3 = this.mActivity.obtainStyledAttributes(THEME_ATTRS);
        Drawable result2 = a3.getDrawable(0);
        a3.recycle();
        return result2;
    }
