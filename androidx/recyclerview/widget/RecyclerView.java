...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (a3.getInt(R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a3.getBoolean(R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a3.getDrawable(R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a3.getDrawable(R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a3.getDrawable(R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a3.getDrawable(R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a3.recycle();
    ...
    boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        return (consumedX == 0 && consumedY2 == 0) ? false : true;
    }
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (!canRunFocusFailure || !(direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int absDir = direction == 2 ? AlErrorCode.ERR_NOT_SUPPORTED : 33;
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH holder, int position) {
            ...
            holder.setFlags(1, NBioBSPJNI.ERROR.NBioAPIERROR_ENROLL_EVENT_REMOVE);
    ...
    public static abstract class LayoutManager {
        ...
        public int getItemCount() {
            RecyclerView recyclerView = this.mRecyclerView;
            Adapter a2 = recyclerView != null ? recyclerView.getAdapter() : null;
            if (a2 != null) {
