...
public class AnimatorInflaterCompat {
            ...
            if ((type != 3 || parser.getDepth() > depth) && type != 1) {
                if (type == 2) {
                    ...
                    if (name.equals("objectAnimator")) {
                        ...
                        TypedArray a2 = TypedArrayUtils.obtainAttributes(res, theme, attrs, AndroidResources.STYLEABLE_ANIMATOR_SET);
                        createAnimatorFromXml(context, res, theme, parser, attrs, (AnimatorSet) anim2, TypedArrayUtils.getNamedInt(a2, parser, "ordering", 0, 0), pixelSize);
                        a2.recycle();
                        anim = anim2;
    ...
    private static Keyframe loadKeyframe(Context context, Resources res, Resources.Theme theme, AttributeSet attrs, int valueType, XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        if (!hasValue) {
            ...
            keyframe2 = Keyframe.ofFloat(fraction, TypedArrayUtils.getNamedFloat(a2, parser, "value", 0, 0.0f));
        } else if (valueType == 1 || valueType == 3) {
            keyframe2 = Keyframe.ofInt(fraction, TypedArrayUtils.getNamedInt(a2, parser, "value", 0, 0));
        }
