...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void inflate(Resources res, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        updateStateFromTypedArray(a2, parser, theme);
        a2.recycle();
    ...
    private void updateStateFromTypedArray(TypedArray a2, XmlPullParser parser, Resources.Theme theme) throws XmlPullParserException {
        VectorDrawableCompatState state = this.mVectorState;
        VPathRenderer pathRenderer = state.mVPathRenderer;
        state.mTintMode = parseTintModeCompat(TypedArrayUtils.getNamedInt(a2, parser, "tintMode", 6, -1), PorterDuff.Mode.SRC_IN);
        ColorStateList tint = TypedArrayUtils.getNamedColorStateList(a2, parser, theme, "tint", 1);
        if (tint != null) {
            state.mTint = tint;
        }
        ...
        if (pathRenderer.mViewportWidth <= 0.0f) {
            ...
            if (pathRenderer.mBaseWidth <= 0.0f) {
                ...
                pathRenderer.setAlpha(TypedArrayUtils.getNamedFloat(a2, parser, "alpha", 4, pathRenderer.getAlpha()));
    ...
    public static class VClipPath extends VPath {
        ...
        private void updateStateFromTypedArray(TypedArray a2, XmlPullParser parser) {
            ...
            this.mFillRule = TypedArrayUtils.getNamedInt(a2, parser, "fillType", 2, 0);
        }
    ...
    public static class VFullPath extends VPath {
        ...
        private void updateStateFromTypedArray(TypedArray a2, XmlPullParser parser, Resources.Theme theme) {
            this.mThemeAttrs = null;
            if (TypedArrayUtils.hasAttribute(parser, "pathData")) {
                String pathName = a2.getString(0);
                if (pathName != null) {
                ...
                this.mFillColor = TypedArrayUtils.getNamedComplexColor(a2, parser, theme, "fillColor", 1, 0);
                this.mFillAlpha = TypedArrayUtils.getNamedFloat(a2, parser, "fillAlpha", 12, this.mFillAlpha);
                this.mStrokeLineCap = getStrokeLineCap(TypedArrayUtils.getNamedInt(a2, parser, "strokeLineCap", 8, -1), this.mStrokeLineCap);
                this.mStrokeLineJoin = getStrokeLineJoin(TypedArrayUtils.getNamedInt(a2, parser, "strokeLineJoin", 9, -1), this.mStrokeLineJoin);
                this.mStrokeMiterlimit = TypedArrayUtils.getNamedFloat(a2, parser, "strokeMiterLimit", 10, this.mStrokeMiterlimit);
                this.mStrokeColor = TypedArrayUtils.getNamedComplexColor(a2, parser, theme, "strokeColor", 3, 0);
