...
public class StateListDrawable extends DrawableContainer {
    ...
    public void inflate(Context context, Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray a2 = TypedArrayUtils.obtainAttributes(r, theme, attrs, R.styleable.StateListDrawable);
    ...
    private void updateStateFromTypedArray(TypedArray a2) {
        ...
        state.mVariablePadding = a2.getBoolean(R.styleable.StateListDrawable_android_variablePadding, state.mVariablePadding);
        state.mConstantSize = a2.getBoolean(R.styleable.StateListDrawable_android_constantSize, state.mConstantSize);
        state.mEnterFadeDuration = a2.getInt(R.styleable.StateListDrawable_android_enterFadeDuration, state.mEnterFadeDuration);
        state.mExitFadeDuration = a2.getInt(R.styleable.StateListDrawable_android_exitFadeDuration, state.mExitFadeDuration);
        state.mDither = a2.getBoolean(R.styleable.StateListDrawable_android_dither, state.mDither);
    }
            ...
            if (type2 != i) {
                ...
                if (type2 == 2) {
                    if (depth > innerDepth) {
                        ...
                        TypedArray a2 = TypedArrayUtils.obtainAttributes(r, theme, attrs, R.styleable.StateListDrawableItem);
                        Drawable dr = null;
                        int drawableId = a2.getResourceId(R.styleable.StateListDrawableItem_android_drawable, -1);
                        if (drawableId > 0) {
