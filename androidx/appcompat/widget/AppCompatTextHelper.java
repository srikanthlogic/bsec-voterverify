...
public class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, attrs, R.styleable.AppCompatTextHelper, defStyleAttr, 0);
        TextView textView = this.mView;
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), R.styleable.AppCompatTextHelper, attrs, a2.getWrappedTypeArray(), defStyleAttr, 0);
        int ap = a2.getResourceId(R.styleable.AppCompatTextHelper_android_textAppearance, -1);
        if (a2.hasValue(R.styleable.AppCompatTextHelper_android_drawableLeft)) {
            this.mDrawableLeftTint = createTintInfo(context, drawableManager3, a2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (a2.hasValue(R.styleable.AppCompatTextHelper_android_drawableTop)) {
            this.mDrawableTopTint = createTintInfo(context, drawableManager3, a2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (a2.hasValue(R.styleable.AppCompatTextHelper_android_drawableRight)) {
            this.mDrawableRightTint = createTintInfo(context, drawableManager3, a2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (a2.hasValue(R.styleable.AppCompatTextHelper_android_drawableBottom)) {
            this.mDrawableBottomTint = createTintInfo(context, drawableManager3, a2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableBottom, 0));
        }
        if (Build.VERSION.SDK_INT >= 17) {
            if (a2.hasValue(R.styleable.AppCompatTextHelper_android_drawableStart)) {
                this.mDrawableStartTint = createTintInfo(context, drawableManager3, a2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableStart, 0));
            }
            if (a2.hasValue(R.styleable.AppCompatTextHelper_android_drawableEnd)) {
                this.mDrawableEndTint = createTintInfo(context, drawableManager3, a2.getResourceId(R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
            }
        }
        a2.recycle();
        ...
        if (ap != -1) {
            TintTypedArray a3 = TintTypedArray.obtainStyledAttributes(context, ap, R.styleable.TextAppearance);
            if (!hasPwdTm && a3.hasValue(R.styleable.TextAppearance_textAllCaps)) {
                allCapsSet2 = true;
                allCaps2 = a3.getBoolean(R.styleable.TextAppearance_textAllCaps, false);
            }
            ...
            if (Build.VERSION.SDK_INT < 23) {
                ...
                if (a3.hasValue(R.styleable.TextAppearance_android_textColorLink)) {
                    textColorLink2 = a3.getColorStateList(R.styleable.TextAppearance_android_textColorLink);
                }
            }
            if (a3.hasValue(R.styleable.TextAppearance_textLocale)) {
                localeListString3 = a3.getString(R.styleable.TextAppearance_textLocale);
            }
            if (Build.VERSION.SDK_INT >= 26 && a3.hasValue(R.styleable.TextAppearance_fontVariationSettings)) {
                fontVariation2 = a3.getString(R.styleable.TextAppearance_fontVariationSettings);
            }
            a3.recycle();
        }
        TintTypedArray a4 = TintTypedArray.obtainStyledAttributes(context, attrs, R.styleable.TextAppearance, defStyleAttr, 0);
        if (hasPwdTm || !a4.hasValue(R.styleable.TextAppearance_textAllCaps)) {
            allCaps = allCaps2;
            allCapsSet = allCapsSet2;
        } else {
            allCaps = a4.getBoolean(R.styleable.TextAppearance_textAllCaps, false);
            allCapsSet = true;
        }
        if (Build.VERSION.SDK_INT < 23) {
            if (a4.hasValue(R.styleable.TextAppearance_android_textColor)) {
                textColor2 = a4.getColorStateList(R.styleable.TextAppearance_android_textColor);
            }
            if (a4.hasValue(R.styleable.TextAppearance_android_textColorHint)) {
                textColorHint = a4.getColorStateList(R.styleable.TextAppearance_android_textColorHint);
            }
            if (a4.hasValue(R.styleable.TextAppearance_android_textColorLink)) {
                textColorLink = textColor2;
                textColor = a4.getColorStateList(R.styleable.TextAppearance_android_textColorLink);
            } else {
                textColorLink = textColor2;
        ...
        if (a4.hasValue(R.styleable.TextAppearance_textLocale)) {
            localeListString = a4.getString(R.styleable.TextAppearance_textLocale);
        } else {
            localeListString = localeListString3;
        }
        if (Build.VERSION.SDK_INT < 26 || !a4.hasValue(R.styleable.TextAppearance_fontVariationSettings)) {
            fontVariation = fontVariation2;
        } else {
            fontVariation = a4.getString(R.styleable.TextAppearance_fontVariationSettings);
        }
        if (Build.VERSION.SDK_INT < 28) {
            drawableManager = drawableManager3;
        } else if (!a4.hasValue(R.styleable.TextAppearance_android_textSize)) {
            drawableManager = drawableManager3;
        } else if (a4.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, -1) == 0) {
            drawableManager = drawableManager3;
        ...
        TintTypedArray a5 = TintTypedArray.obtainStyledAttributes(context, attrs, R.styleable.AppCompatTextView);
        Drawable drawableStart = null;
        Drawable drawableEnd = null;
        Drawable drawableLeft = null;
        Drawable drawableTop = null;
        int drawableLeftId = a5.getResourceId(R.styleable.AppCompatTextView_drawableLeftCompat, -1);
        if (drawableLeftId != -1) {
        ...
        int drawableTopId = a5.getResourceId(R.styleable.AppCompatTextView_drawableTopCompat, -1);
        if (drawableTopId != -1) {
            drawableTop = drawableManager2.getDrawable(context, drawableTopId);
        }
        int drawableRightId = a5.getResourceId(R.styleable.AppCompatTextView_drawableRightCompat, -1);
        if (drawableRightId != -1) {
            drawableRight = drawableManager2.getDrawable(context, drawableRightId);
        }
        int drawableBottomId = a5.getResourceId(R.styleable.AppCompatTextView_drawableBottomCompat, -1);
        if (drawableBottomId != -1) {
            drawableBottom = drawableManager2.getDrawable(context, drawableBottomId);
        } else {
            drawableBottom = null;
        }
        int drawableStartId = a5.getResourceId(R.styleable.AppCompatTextView_drawableStartCompat, -1);
        if (drawableStartId != -1) {
            drawableStart = drawableManager2.getDrawable(context, drawableStartId);
        }
        int drawableEndId = a5.getResourceId(R.styleable.AppCompatTextView_drawableEndCompat, -1);
        if (drawableEndId != -1) {
        ...
        if (a5.hasValue(R.styleable.AppCompatTextView_drawableTint)) {
            TextViewCompat.setCompoundDrawableTintList(this.mView, a5.getColorStateList(R.styleable.AppCompatTextView_drawableTint));
        }
        if (a5.hasValue(R.styleable.AppCompatTextView_drawableTintMode)) {
            TextViewCompat.setCompoundDrawableTintMode(this.mView, DrawableUtils.parseTintMode(a5.getInt(R.styleable.AppCompatTextView_drawableTintMode, -1), null));
        }
        int firstBaselineToTopHeight = a5.getDimensionPixelSize(R.styleable.AppCompatTextView_firstBaselineToTopHeight, -1);
        int lastBaselineToBottomHeight = a5.getDimensionPixelSize(R.styleable.AppCompatTextView_lastBaselineToBottomHeight, -1);
        int lineHeight = a5.getDimensionPixelSize(R.styleable.AppCompatTextView_lineHeight, -1);
        a5.recycle();
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a2) {
        ...
        boolean z = false;
        if (Build.VERSION.SDK_INT >= 28) {
            this.mFontWeight = a2.getInt(R.styleable.TextAppearance_android_textFontWeight, -1);
            if (this.mFontWeight != -1) {
        ...
        if (a2.hasValue(R.styleable.TextAppearance_android_fontFamily) || a2.hasValue(R.styleable.TextAppearance_fontFamily)) {
            ...
            if (a2.hasValue(R.styleable.TextAppearance_fontFamily)) {
            ...
            if (!context.isRestricted()) {
                ...
                try {
                    Typeface typeface = a2.getFont(fontFamilyId, this.mStyle, new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                        @Override // androidx.core.content.res.ResourcesCompat.FontCallback
                        public void onFontRetrieved(Typeface typeface2) {
                            int i;
                            if (Build.VERSION.SDK_INT >= 28 && (i = fontWeight) != -1) {
                                typeface2 = Typeface.create(typeface2, i, (style & 2) != 0);
                            }
                            AppCompatTextHelper.this.onAsyncTypefaceReceived(textViewWeak, typeface2);
                        }
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            if (a2.hasValue(R.styleable.TextAppearance_android_textColor) && (textColor = a2.getColorStateList(R.styleable.TextAppearance_android_textColor)) != null) {
                this.mView.setTextColor(textColor);
            }
            if (a2.hasValue(R.styleable.TextAppearance_android_textColorLink) && (textColorLink = a2.getColorStateList(R.styleable.TextAppearance_android_textColorLink)) != null) {
                this.mView.setLinkTextColor(textColorLink);
            }
            if (a2.hasValue(R.styleable.TextAppearance_android_textColorHint) && (textColorHint = a2.getColorStateList(R.styleable.TextAppearance_android_textColorHint)) != null) {
                this.mView.setHintTextColor(textColorHint);
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26 && a2.hasValue(R.styleable.TextAppearance_fontVariationSettings) && (fontVariation = a2.getString(R.styleable.TextAppearance_fontVariationSettings)) != null) {
            this.mView.setFontVariationSettings(fontVariation);
        }
        a2.recycle();
        Typeface typeface = this.mFontTypeface;
