...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    /* JADX WARN: Type inference failed for: r2v6, types: [android.content.res.TypedArray] */
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Resources.Theme popupTheme) {
        ...
        TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, attrs, R.styleable.Spinner, defStyleAttr, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (popupTheme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, popupTheme);
        } else {
            int popupThemeResId = a2.getResourceId(R.styleable.Spinner_popupTheme, 0);
        ...
        if (mode == 0) {
            ...
            this.mPopup.setPromptText(a2.getString(R.styleable.Spinner_android_prompt));
        } else if (mode == 1) {
            ...
            popup.setPromptText(a2.getString(R.styleable.Spinner_android_prompt));
            pa.recycle();
            this.mPopup = popup;
        ...
        CharSequence[] entries = a2.getTextArray(R.styleable.Spinner_android_entries);
        if (entries != null) {
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (ss.mShowDropdown && (vto = getViewTreeObserver()) != null) {
            vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.appcompat.widget.AppCompatSpinner.2
