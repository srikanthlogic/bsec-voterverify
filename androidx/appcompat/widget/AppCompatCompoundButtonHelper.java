...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        int resourceId;
        int resourceId2;
        TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, R.styleable.CompoundButton, defStyleAttr, 0);
        CompoundButton compoundButton = this.mView;
        ViewCompat.saveAttributeDataForStyleable(compoundButton, compoundButton.getContext(), R.styleable.CompoundButton, attrs, a2.getWrappedTypeArray(), defStyleAttr, 0);
        boolean buttonDrawableLoaded = false;
        try {
            if (a2.hasValue(R.styleable.CompoundButton_buttonCompat) && (resourceId2 = a2.getResourceId(R.styleable.CompoundButton_buttonCompat, 0)) != 0) {
                try {
            ...
            if (!buttonDrawableLoaded && a2.hasValue(R.styleable.CompoundButton_android_button) && (resourceId = a2.getResourceId(R.styleable.CompoundButton_android_button, 0)) != 0) {
