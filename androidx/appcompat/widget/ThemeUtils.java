...
public class ThemeUtils {
    ...
    public static int getThemeAttrColor(Context context, int attr) {
        int[] iArr = TEMP_ARRAY;
        iArr[0] = attr;
        TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, (AttributeSet) null, iArr);
        try {
    ...
    public static void checkAppCompatTheme(View view, Context context) {
        TypedArray a2 = context.obtainStyledAttributes(R.styleable.AppCompatTheme);
        try {
