...
public abstract class Visibility extends Transition {
    ...
    public Visibility(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a2 = context.obtainStyledAttributes(attrs, Styleable.VISIBILITY_TRANSITION);
        int mode = TypedArrayUtils.getNamedInt(a2, (XmlResourceParser) attrs, "transitionVisibilityMode", 0, 0);
        a2.recycle();
        if (mode != 0) {
            setMode(mode);
        }
