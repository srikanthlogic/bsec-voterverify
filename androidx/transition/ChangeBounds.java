...
public class ChangeBounds extends Transition {
    ...
    public ChangeBounds(Context context, AttributeSet attrs) {
        ...
        this.mResizeClip = false;
        this.mReparent = false;
        TypedArray a2 = context.obtainStyledAttributes(attrs, Styleable.CHANGE_BOUNDS);
        boolean resizeClip = TypedArrayUtils.getNamedBoolean(a2, (XmlResourceParser) attrs, "resizeClip", 0, false);
        a2.recycle();
