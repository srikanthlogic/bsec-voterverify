...
public class TransitionSet extends Transition {
    ...
    public TransitionSet(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a2 = context.obtainStyledAttributes(attrs, Styleable.TRANSITION_SET);
        setOrdering(TypedArrayUtils.getNamedInt(a2, (XmlResourceParser) attrs, "transitionOrdering", 0, 0));
        a2.recycle();
    }
