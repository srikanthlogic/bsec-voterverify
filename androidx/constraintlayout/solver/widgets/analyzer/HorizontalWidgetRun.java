                    ...
                    if (s1 && s2 && e1 && e2) {
                        ...
                        if (this.start.readyToSolve && this.end.readyToSolve) {
                            ...
                            if (definedSide == -1 || definedSide == 0) {
                                ...
                                int dy = (int) ((((float) ldx) * ratio2) + 0.5f);
                                int ldy = getLimitedDimension(dy, 1);
                                if (dy != ldy) {
                                    ldx = (int) ((((float) ldy) / ratio2) + 0.5f);
                                }
                                ...
                                int dy2 = (int) ((((float) ldx2) / ratio2) + 0.5f);
                                int ldy2 = getLimitedDimension(dy2, 1);
                                if (dy2 != ldy2) {
                                    ldx2 = (int) ((((float) ldy2) * ratio2) + 0.5f);
                                }
                        ...
                        if (secondStart.readyToSolve && secondEnd.readyToSolve) {
                            ...
                            if (definedSide != -1) {
                                if (definedSide == 0) {
                                    ...
                                    int dx = (int) ((((float) ldy3) * ratio3) + 0.5f);
                                    int ldx3 = getLimitedDimension(dx, 0);
                                    if (dx != ldx3) {
                                        ldy3 = (int) ((((float) ldx3) / ratio3) + 0.5f);
                                    }
                            ...
                            int dx2 = (int) ((((float) ldy4) / ratio3) + 0.5f);
                            int ldx4 = getLimitedDimension(dx2, 0);
                            if (dx2 != ldx4) {
                                ldy4 = (int) ((((float) ldx4) * ratio3) + 0.5f);
                            }
