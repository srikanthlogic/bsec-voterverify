...
public class HyperSpline {
    ...
    /* JADX INFO: Multiple debug info for r4v11 androidx.constraintlayout.motion.utils.HyperSpline$Cubic[]: [D('i' int), D('C' androidx.constraintlayout.motion.utils.HyperSpline$Cubic[])] */
    ...
    public static class Cubic {
        ...
        public Cubic(double a2, double b, double c, double d) {
            this.mA = a2;
            this.mB = b;
            this.mC = c;
            this.mD = d;
