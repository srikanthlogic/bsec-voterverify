        ...
        public static void read(KeyTrigger c, TypedArray a2, Context context) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (mAttrMap.get(attr)) {
                    case 1:
                        c.mNegativeCross = a2.getString(attr);
                        continue;
                    case 2:
                        c.mPositiveCross = a2.getString(attr);
                        continue;
                    case 4:
                        c.mCross = a2.getString(attr);
                        continue;
                    case 5:
                        c.mTriggerSlack = a2.getFloat(attr, c.mTriggerSlack);
                        continue;
                    case 6:
                        c.mTriggerID = a2.getResourceId(attr, c.mTriggerID);
                        continue;
                    case 7:
                    ...
                    case 8:
                        c.mFramePosition = a2.getInteger(attr, c.mFramePosition);
                        c.mFireThreshold = (((float) c.mFramePosition) + 0.5f) / 100.0f;
                        continue;
                    case 9:
                        c.mTriggerCollisionId = a2.getResourceId(attr, c.mTriggerCollisionId);
                        continue;
                    case 10:
                        c.mPostLayout = a2.getBoolean(attr, c.mPostLayout);
                        continue;
                    case 11:
                        c.mTriggerReceiver = a2.getResourceId(attr, c.mTriggerReceiver);
                        break;
                }
