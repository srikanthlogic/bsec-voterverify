                ...
                switch (mAttrMap.get(attr)) {
                    ...
                    case 3:
                        if (a2.peekValue(attr).type == 3) {
                            ...
                            c.mTransitionEasing = Easing.NAMED_EASING[a2.getInteger(attr, 0)];
                            break;
                        }
                    case 4:
                        ...
                        break;
                    case 5:
                        c.mDrawPath = a2.getInt(attr, c.mDrawPath);
                        break;
                    case 6:
                        c.mPercentX = a2.getFloat(attr, c.mPercentX);
                        break;
                    case 7:
                        c.mPercentY = a2.getFloat(attr, c.mPercentY);
                        break;
                    case 8:
                        float f = a2.getFloat(attr, c.mPercentHeight);
                        c.mPercentWidth = f;
                        c.mPercentHeight = f;
                        break;
                    case 9:
                        c.mPositionType = a2.getInt(attr, c.mPositionType);
                        break;
                    case 10:
                        c.mPathMotionArc = a2.getInt(attr, c.mPathMotionArc);
                        break;
                    case 11:
                        c.mPercentWidth = a2.getFloat(attr, c.mPercentWidth);
                        break;
                    case 12:
                        c.mPercentHeight = a2.getFloat(attr, c.mPercentHeight);
                        break;
                    default:
