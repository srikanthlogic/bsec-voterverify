...
public final class ColorUtils {
    ...
    public static int compositeColors(int foreground, int background) {
        ...
        return Color.argb(a2, compositeComponent(Color.red(foreground), fgAlpha, Color.red(background), bgAlpha, a2), compositeComponent(Color.green(foreground), fgAlpha, Color.green(background), bgAlpha, a2), compositeComponent(Color.blue(foreground), fgAlpha, Color.blue(background), bgAlpha, a2));
    }
    ...
    public static void LABToXYZ(double l, double a2, double b, double[] outXyz) {
    ...
    public static int LABToColor(double l, double a2, double b) {
        double[] result = getTempDouble3Array();
