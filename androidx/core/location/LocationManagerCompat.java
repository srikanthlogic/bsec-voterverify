    ...
    private static boolean registerGnssStatusCallback(final LocationManager locationManager, Handler baseHandler, Executor executor, GnssStatusCompat.Callback callback) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            synchronized (sGnssStatusListeners) {
                GnssStatusTransport transport2 = (GnssStatusTransport) sGnssStatusListeners.get(callback);
                if (transport2 == null) {
            ...
            synchronized (sGnssStatusListeners) {
                PreRGnssStatusTransport transport3 = (PreRGnssStatusTransport) sGnssStatusListeners.get(callback);
                if (transport3 == null) {
                ...
                sGnssStatusListeners.put(callback, transport3);
                return true;
            }
        } else {
            Preconditions.checkArgument(baseHandler != null);
            synchronized (sGnssStatusListeners) {
                GpsStatusTransport transport4 = (GpsStatusTransport) sGnssStatusListeners.get(callback);
                if (transport4 == null) {
                ...
                try {
                    try {
                        long remainingNanos = TimeUnit.SECONDS.toNanos(4);
    ...
    public static class GpsStatusTransport implements GpsStatus.Listener {
        ...
        public void onGpsStatusChanged(int event) {
            ...
            if (executor != null) {
                ...
                } else if (event == 4 && (gpsStatus = this.mLocationManager.getGpsStatus(null)) != null) {
