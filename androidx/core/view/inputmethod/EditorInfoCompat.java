...
public final class EditorInfoCompat {
    ...
    public static String[] getContentMimeTypes(EditorInfo editorInfo) {
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (result2 == null) {
                result2 = editorInfo.extras.getStringArray("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES");
            }
    ...
    public static int getProtocol(EditorInfo editorInfo) {
        ...
        boolean hasOldKey = editorInfo.extras.containsKey("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES");
