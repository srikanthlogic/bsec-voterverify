...
public final class SpannedStringKt {
    ...
    public static /* synthetic */ Object[] getSpans$default(Spanned $this$getSpans, int start, int end, int i, Object obj) {
        if ((i & 1) != 0) {
            start = 0;
        }
        if ((i & 2) != 0) {
        ...
        Intrinsics.checkParameterIsNotNull($this$getSpans, "$this$getSpans");
    ...
    public static final /* synthetic */ <T> T[] getSpans(Spanned $this$getSpans, int start, int end) {
        Intrinsics.checkParameterIsNotNull($this$getSpans, "$this$getSpans");
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_DIRECTION_TRUE);
        T[] tArr = (T[]) $this$getSpans.getSpans(start, end, Object.class);
