...
public final class ShareCompat {
    ...
    static String getCallingPackage(Intent intent) {
        ...
        if (result == null) {
            return intent.getStringExtra("androidx.core.app.EXTRA_CALLING_PACKAGE");
        }
        return result;
    }
    ...
    static ComponentName getCallingActivity(Intent intent) {
        ...
        if (result == null) {
            return (ComponentName) intent.getParcelableExtra("androidx.core.app.EXTRA_CALLING_ACTIVITY");
        }
        return result;
    }
