...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a2.hasValue(R.styleable.CardView_cardBackgroundColor)) {
            backgroundColor = a2.getColorStateList(R.styleable.CardView_cardBackgroundColor);
        } else {
        ...
        float maxElevation2 = a2.getDimension(R.styleable.CardView_cardMaxElevation, 0.0f);
