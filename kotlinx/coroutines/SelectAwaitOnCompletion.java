...
final class SelectAwaitOnCompletion<T, R> extends JobNode<JobSupport> {
    ...
    public SelectAwaitOnCompletion(JobSupport job, SelectInstance<? super R> selectInstance, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        super(job);
