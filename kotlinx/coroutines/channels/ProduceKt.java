...
public final class ProduceKt {
    ...
    public static final <E> ReceiveChannel<E> produce(CoroutineScope $receiver, CoroutineContext context, int capacity, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
    ...
    public static final <E> ReceiveChannel<E> produce(CoroutineScope $receiver, CoroutineContext context, int capacity, Function1<? super Throwable, Unit> function1, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intrinsics.checkParameterIsNotNull(function2, "block");
        ProducerCoroutine coroutine = new ProducerCoroutine(CoroutineContextKt.newCoroutineContext($receiver, context), ChannelKt.Channel(capacity));
