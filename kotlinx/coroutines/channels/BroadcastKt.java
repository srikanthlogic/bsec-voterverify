...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(ReceiveChannel<? extends E> receiveChannel, int capacity, CoroutineStart start) {
        Intrinsics.checkParameterIsNotNull(receiveChannel, "receiver$0");
        Intrinsics.checkParameterIsNotNull(start, "start");
        return broadcast(GlobalScope.INSTANCE, Dispatchers.getUnconfined(), capacity, start, ChannelsKt.consumes(receiveChannel), new BroadcastKt$broadcast$1(receiveChannel, null));
    }
    ...
    public static /* synthetic */ BroadcastChannel broadcast$default(CoroutineScope coroutineScope, CoroutineContext coroutineContext, int i, CoroutineStart coroutineStart, Function1 function1, Function2 function2, int i2, Object obj) {
        ...
        return broadcast(coroutineScope, emptyCoroutineContext, i3, coroutineStart2, function12, function2);
    }

    public static final <E> BroadcastChannel<E> broadcast(CoroutineScope $receiver, CoroutineContext context, int capacity, CoroutineStart start, Function1<? super Throwable, Unit> function1, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
