...
public final class SendElement extends LockFreeLinkedListNode implements Send {
    ...
    public SendElement(Object pollResult, CancellableContinuation<? super Unit> cancellableContinuation) {
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        this.cont.resumeWith(Result.m13constructorimpl(ResultKt.createFailure(sendException)));
    }
