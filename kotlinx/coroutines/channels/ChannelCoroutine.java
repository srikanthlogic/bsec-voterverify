...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public ChannelCoroutine(CoroutineContext parentContext, Channel<E> channel, boolean active) {
