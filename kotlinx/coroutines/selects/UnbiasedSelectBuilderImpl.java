...
public final class UnbiasedSelectBuilderImpl<R> implements SelectBuilder<R> {
    ...
    public void invoke(SelectClause0 $receiver, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        ...
        this.clauses.add(new Function0<Unit>($receiver, function1) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$invoke$1
    ...
    public void onTimeout(long timeMillis, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        Intrinsics.checkParameterIsNotNull(function1, "block");
        this.clauses.add(new Function0<Unit>(timeMillis, function1) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$onTimeout$1
            final /* synthetic */ Function1 $block;
