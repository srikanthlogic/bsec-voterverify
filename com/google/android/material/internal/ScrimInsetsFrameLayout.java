...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a2 = ThemeEnforcement.obtainStyledAttributes(context, attrs, R.styleable.ScrimInsetsFrameLayout, defStyleAttr, R.style.Widget_Design_ScrimInsetsFrameLayout, new int[0]);
        this.insetForeground = a2.getDrawable(R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a2.recycle();
        setWillNotDraw(true);
