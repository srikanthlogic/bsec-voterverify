...
public class ChipGroup extends FlowLayout {
    ...
    public ChipGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a2 = ThemeEnforcement.obtainStyledAttributes(context, attrs, R.styleable.ChipGroup, defStyleAttr, R.style.Widget_MaterialComponents_ChipGroup, new int[0]);
        int chipSpacing = a2.getDimensionPixelOffset(R.styleable.ChipGroup_chipSpacing, 0);
        setChipSpacingHorizontal(a2.getDimensionPixelOffset(R.styleable.ChipGroup_chipSpacingHorizontal, chipSpacing));
        setChipSpacingVertical(a2.getDimensionPixelOffset(R.styleable.ChipGroup_chipSpacingVertical, chipSpacing));
        ...
        int checkedChip = a2.getResourceId(R.styleable.ChipGroup_checkedChip, -1);
        if (checkedChip != -1) {
