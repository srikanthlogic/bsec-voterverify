...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Drawable.Callback {
    ...
    private void loadFromAttributes(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a2 = ThemeEnforcement.obtainStyledAttributes(this.context, attrs, R.styleable.Chip, defStyleAttr, defStyleRes, new int[0]);
        setChipBackgroundColor(MaterialResources.getColorStateList(this.context, a2, R.styleable.Chip_chipBackgroundColor));
        setChipMinHeight(a2.getDimension(R.styleable.Chip_chipMinHeight, 0.0f));
        setChipCornerRadius(a2.getDimension(R.styleable.Chip_chipCornerRadius, 0.0f));
        setChipStrokeColor(MaterialResources.getColorStateList(this.context, a2, R.styleable.Chip_chipStrokeColor));
        setChipStrokeWidth(a2.getDimension(R.styleable.Chip_chipStrokeWidth, 0.0f));
        setRippleColor(MaterialResources.getColorStateList(this.context, a2, R.styleable.Chip_rippleColor));
        setText(a2.getText(R.styleable.Chip_android_text));
        setTextAppearance(MaterialResources.getTextAppearance(this.context, a2, R.styleable.Chip_android_textAppearance));
        int ellipsize = a2.getInt(R.styleable.Chip_android_ellipsize, 0);
        if (ellipsize == 1) {
        ...
        setChipIconVisible(a2.getBoolean(R.styleable.Chip_chipIconVisible, false));
        if (!(attrs == null || attrs.getAttributeValue(NAMESPACE_APP, "chipIconEnabled") == null || attrs.getAttributeValue(NAMESPACE_APP, "chipIconVisible") != null)) {
            setChipIconVisible(a2.getBoolean(R.styleable.Chip_chipIconEnabled, false));
        }
        setChipIcon(MaterialResources.getDrawable(this.context, a2, R.styleable.Chip_chipIcon));
        setChipIconTint(MaterialResources.getColorStateList(this.context, a2, R.styleable.Chip_chipIconTint));
        setChipIconSize(a2.getDimension(R.styleable.Chip_chipIconSize, 0.0f));
        setCloseIconVisible(a2.getBoolean(R.styleable.Chip_closeIconVisible, false));
        if (!(attrs == null || attrs.getAttributeValue(NAMESPACE_APP, "closeIconEnabled") == null || attrs.getAttributeValue(NAMESPACE_APP, "closeIconVisible") != null)) {
            setCloseIconVisible(a2.getBoolean(R.styleable.Chip_closeIconEnabled, false));
        }
        setCloseIcon(MaterialResources.getDrawable(this.context, a2, R.styleable.Chip_closeIcon));
        setCloseIconTint(MaterialResources.getColorStateList(this.context, a2, R.styleable.Chip_closeIconTint));
        setCloseIconSize(a2.getDimension(R.styleable.Chip_closeIconSize, 0.0f));
        setCheckable(a2.getBoolean(R.styleable.Chip_android_checkable, false));
        setCheckedIconVisible(a2.getBoolean(R.styleable.Chip_checkedIconVisible, false));
        if (!(attrs == null || attrs.getAttributeValue(NAMESPACE_APP, "checkedIconEnabled") == null || attrs.getAttributeValue(NAMESPACE_APP, "checkedIconVisible") != null)) {
            setCheckedIconVisible(a2.getBoolean(R.styleable.Chip_checkedIconEnabled, false));
        }
        setCheckedIcon(MaterialResources.getDrawable(this.context, a2, R.styleable.Chip_checkedIcon));
        setShowMotionSpec(MotionSpec.createFromAttribute(this.context, a2, R.styleable.Chip_showMotionSpec));
        setHideMotionSpec(MotionSpec.createFromAttribute(this.context, a2, R.styleable.Chip_hideMotionSpec));
        setChipStartPadding(a2.getDimension(R.styleable.Chip_chipStartPadding, 0.0f));
        setIconStartPadding(a2.getDimension(R.styleable.Chip_iconStartPadding, 0.0f));
        setIconEndPadding(a2.getDimension(R.styleable.Chip_iconEndPadding, 0.0f));
        setTextStartPadding(a2.getDimension(R.styleable.Chip_textStartPadding, 0.0f));
        setTextEndPadding(a2.getDimension(R.styleable.Chip_textEndPadding, 0.0f));
        setCloseIconStartPadding(a2.getDimension(R.styleable.Chip_closeIconStartPadding, 0.0f));
        setCloseIconEndPadding(a2.getDimension(R.styleable.Chip_closeIconEndPadding, 0.0f));
        setChipEndPadding(a2.getDimension(R.styleable.Chip_chipEndPadding, 0.0f));
        setMaxWidth(a2.getDimensionPixelSize(R.styleable.Chip_android_maxWidth, Integer.MAX_VALUE));
        a2.recycle();
    }
