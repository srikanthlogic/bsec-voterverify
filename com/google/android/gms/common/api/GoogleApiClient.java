    ...
    public static final class Builder {
        ...
        public final GoogleApiClient build() {
            ...
            for (Api<?> api2 : this.zak.keySet()) {
                ...
                Api.Client buildClient = abstractClientBuilder.buildClient(this.zaj, this.zao, buildClientSettings, (ClientSettings) apiOptions, (ConnectionCallbacks) zaq, (OnConnectionFailedListener) zaq);
