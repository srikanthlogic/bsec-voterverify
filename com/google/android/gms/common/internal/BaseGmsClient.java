...
public abstract class BaseGmsClient<T extends IInterface> {
        ...
        synchronized (this.zzp) {
            ...
            if (i == 1) {
                ...
                if (this.zzv != 3 || getLocalStartServiceAction() == null) {
                    zzl = new zzl(getStartServicePackage(), getStartServiceAction(), false, GmsClientSupervisor.getDefaultBindFlags(), getUseDynamicLookup());
                } else {
                    zzl = new zzl(getContext().getPackageName(), getLocalStartServiceAction(), true, GmsClientSupervisor.getDefaultBindFlags(), false);
                }
                this.zzk = zzl;
    ...
    public String getEndpointPackageName() {
        zzl zzl;
        if (isConnected() && (zzl = this.zzk) != null) {
            return zzl.zzb();
        }
