...
public final class zzd extends zze {
    ...
    public zzd(zzfs zzfs) {
        super(zzfs);
    }

    public static /* bridge */ /* synthetic */ void zza(zzd zzd, String str, long j) {
        zzd.zzg();
    ...
    public static /* bridge */ /* synthetic */ void zzb(zzd zzd, String str, long j) {
        zzd.zzg();
        Preconditions.checkNotEmpty(str);
        Integer num = zzd.zzb.get(str);
        if (num != null) {
            zzic zzj = ((zze) zzd).zzs.zzs().zzj(false);
    ...
    private final void zzh(long j, zzic zzic) {
        if (zzic == null) {
            ...
            zzku.zzJ(zzic, bundle, true);
            ((zze) this).zzs.zzq().zzF("am", "_xa", bundle);
        }
    }

    private final void zzi(String str, long j, zzic zzic) {
        if (zzic == null) {
            ...
            bundle.putLong("_xt", j);
            zzku.zzJ(zzic, bundle, true);
            ((zze) this).zzs.zzq().zzF("am", "_xu", bundle);
        }
    }
