...
public final class zzkb extends zzkd {
    ...
    private final zzam zzi() {
        if (this.zzb == null) {
            this.zzb = new zzka(this, this.zzf.zzq());
        }
        return this.zzb;
    }
    ...
    public final void zzd(long j) {
        ...
        this.zzs.zzf();
        if (j < Math.max(0L, zzdw.zzw.zza(null).longValue()) && !zzi().zze()) {
            zzi().zzd(j);
        }
        this.zzs.zzaw();
        if (Build.VERSION.SDK_INT >= 24) {
        ...
        if (alarmManager != null) {
            this.zzs.zzf();
            alarmManager.setInexactRepeating(2, elapsedRealtime, Math.max(zzdw.zzr.zza(null).longValue(), j), zzh());
        }
    }
}
