...
final class AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Thread_Frame extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame {
    ...
    public boolean equals(Object o) {
        ...
        if (this.pc == that.getPc() && this.symbol.equals(that.getSymbol()) && ((str = this.file) != null ? str.equals(that.getFile()) : that.getFile() == null) && this.offset == that.getOffset() && this.importance == that.getImportance()) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        long j = this.pc;
        int h$ = ((((1 * 1000003) ^ ((int) (j ^ (j >>> 32)))) * 1000003) ^ this.symbol.hashCode()) * 1000003;
        String str = this.file;
        int hashCode = str == null ? 0 : str.hashCode();
        long j2 = this.offset;
        return ((((h$ ^ hashCode) * 1000003) ^ ((int) (j2 ^ (j2 >>> 32)))) * 1000003) ^ this.importance;
    }
