...
public class CrashlyticsReportJsonTransform {
    ...
    public CrashlyticsReport.ApplicationExitInfo applicationExitInfoFromJson(String json) throws IOException {
        try {
            JsonReader jsonReader = new JsonReader(new StringReader(json));
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case '\b':
                    ...
                    break;
                case '\t':
                    builder.setEvents(parseArray(jsonReader, $$Lambda$CrashlyticsReportJsonTransform$Ckb34QcYctmy_Q7QdvSnBmK1U98.INSTANCE));
                    break;
                case '\n':
    ...
    private static CrashlyticsReport.FilesPayload parseNdkPayload(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (c == 0) {
                builder.setFiles(parseArray(jsonReader, $$Lambda$CrashlyticsReportJsonTransform$PcYtebWm8LLEihGxNBWQex7movQ.INSTANCE));
            } else if (c != 1) {
                jsonReader.skipValue();
            } else {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (name.hashCode()) {
                case -1618432855:
                    ...
                    break;
                case -519438642:
                    if (name.equals("developmentPlatform")) {
                        c = 4;
                        break;
                    }
                    break;
                case 213652010:
                    if (name.equals("developmentPlatformVersion")) {
                        c = 5;
                        break;
                    }
                    break;
    ...
    private static CrashlyticsReport.Session.Event.Application parseEventApp(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (c == 0) {
                ...
                builder.setCustomAttributes(parseArray(jsonReader, $$Lambda$CrashlyticsReportJsonTransform$NhzBXeLMMIRDAHryokwvoZKlwo.INSTANCE));
            } else if (c != 4) {
                jsonReader.skipValue();
            } else {
                builder.setInternalKeys(parseArray(jsonReader, $$Lambda$CrashlyticsReportJsonTransform$NhzBXeLMMIRDAHryokwvoZKlwo.INSTANCE));
            }
        }
        jsonReader.endObject();
        return builder.build();
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution parseEventExecution(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (c == 0) {
                builder.setThreads(parseArray(jsonReader, $$Lambda$CrashlyticsReportJsonTransform$NcslUolmMJ2rhykSKHnzkuM2hYY.INSTANCE));
            } else if (c == 1) {
                builder.setException(parseEventExecutionException(jsonReader));
            } else if (c == 2) {
                builder.setSignal(parseEventSignal(jsonReader));
            } else if (c == 3) {
                builder.setBinaries(parseArray(jsonReader, $$Lambda$CrashlyticsReportJsonTransform$CDavwmIaUoxPoo5Upyr1hcsJXE.INSTANCE));
            } else if (c != 4) {
                jsonReader.skipValue();
            } else {
