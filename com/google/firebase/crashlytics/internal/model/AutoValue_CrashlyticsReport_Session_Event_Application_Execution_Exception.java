...
final class AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Exception extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    public boolean equals(Object o) {
        ...
        if (!this.type.equals(that.getType()) || ((str = this.reason) != null ? !str.equals(that.getReason()) : that.getReason() != null) || !this.frames.equals(that.getFrames()) || ((exception = this.causedBy) != null ? !exception.equals(that.getCausedBy()) : that.getCausedBy() != null) || this.overflowCount != that.getOverflowCount()) {
            return false;
        }
        return true;
    }
