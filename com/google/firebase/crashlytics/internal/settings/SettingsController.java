...
public class SettingsController implements SettingsDataProvider {
    ...
    public static SettingsController create(Context context, String googleAppId, IdManager idManager, HttpRequestFactory httpRequestFactory, String versionCode, String versionName, DataCollectionArbiter dataCollectionArbiter) {
        String installerPackageName = idManager.getInstallerPackageName();
        CurrentTimeProvider currentTimeProvider = new SystemCurrentTimeProvider();
        return new SettingsController(context, new SettingsRequest(googleAppId, idManager.getModelName(), idManager.getOsBuildVersionString(), idManager.getOsDisplayVersionString(), idManager, CommonUtils.createInstanceIdFrom(CommonUtils.getMappingFileId(context), googleAppId, versionName, versionCode), versionName, versionCode, DeliveryMechanism.determineFrom(installerPackageName).getId()), currentTimeProvider, new SettingsJsonParser(currentTimeProvider), new CachedSettingsIo(context), new DefaultSettingsSpiCall(String.format(Locale.US, SETTINGS_URL_FORMAT, googleAppId), httpRequestFactory), dataCollectionArbiter);
    }
