...
public final class FirebaseOptions {
    private static final String API_KEY_RESOURCE_NAME;
    private static final String APP_ID_RESOURCE_NAME;
    private static final String DATABASE_URL_RESOURCE_NAME;
    private static final String GA_TRACKING_ID_RESOURCE_NAME;
    private static final String GCM_SENDER_ID_RESOURCE_NAME;
    private static final String PROJECT_ID_RESOURCE_NAME;
    private static final String STORAGE_BUCKET_RESOURCE_NAME;
