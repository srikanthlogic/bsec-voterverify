...
public class ThreadHandoffProducer<T> implements Producer<T> {
    ...
    public void produceResults(final Consumer<T> consumer, final ProducerContext context) {
        ...
        final StatefulProducerRunnable<T> statefulRunnable = new StatefulProducerRunnable<T>(PRODUCER_NAME, producerListener, requestId, consumer) { // from class: com.facebook.imagepipeline.producers.ThreadHandoffProducer.1
