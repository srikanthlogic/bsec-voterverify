...
public class ImagePipelineConfig {
    ...
    private ImagePipelineConfig(Builder builder) {
        ...
        if (webpBitmapFactory2 != null) {
            setWebpBitmapFactory(webpBitmapFactory2, this.mImagePipelineExperiments, new HoneycombBitmapCreator(getPoolFactory()));
    ...
    private static int getMemoryChunkType(Builder builder, ImagePipelineExperiments imagePipelineExperiments) {
        ...
        if (imagePipelineExperiments.isNativeCodeDisabled()) {
            return 1;
        }
        return 0;
    }
    ...
    public static class Builder {
        ...
        public Builder setBitmapMemoryCacheTrimStrategy(CountingMemoryCache.CacheTrimStrategy trimStrategy) {
