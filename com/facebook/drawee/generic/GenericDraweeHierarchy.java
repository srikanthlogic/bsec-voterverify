...
public class GenericDraweeHierarchy implements SettableDraweeHierarchy {
    ...
    public GenericDraweeHierarchy(GenericDraweeHierarchyBuilder builder) {
        ...
        layers[2] = buildActualImageBranch(this.mActualImageWrapper, builder.getActualImageScaleType(), builder.getActualImageFocusPoint(), builder.getActualImageColorFilter());
