...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(List<? extends Certificate> $this$toTypedArray$iv, String hostname) throws SSLPeerUnverifiedException {
        ...
        try {
            ...
            SSLPeerUnverifiedException $this$apply = new SSLPeerUnverifiedException(e2.getMessage());
    ...
    public static final class Companion {
        ...
        public final AndroidCertificateChainCleaner build(X509TrustManager trustManager) {
            ...
            try {
                ...
                Object extensions = extensionsClass.getConstructor(X509TrustManager.class).newInstance(trustManager);
