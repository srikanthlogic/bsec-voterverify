...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1045deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1047deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m1046deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
    ...
    public int hashCode() {
        ...
        return ((result + i2) * 31) + (!this.supportsTlsExtensions ? 1 : 0);
    }
    ...
    public static final class Builder {
        ...
        /* JADX INFO: Multiple debug info for r2v7 java.util.ArrayList: [D('$this$map$iv' java.lang.Object[]), D('$this$toTypedArray$iv' java.util.Collection)] */
