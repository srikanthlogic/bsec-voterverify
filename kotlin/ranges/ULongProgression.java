...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        if (step == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m906getProgressionLastElement7ftBX0g(start, endInclusive, step);
            this.step = step;
        } else {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m167constructorimpl(j ^ ULong.m167constructorimpl(j >>> 32))) * 31) + ((int) ULong.m167constructorimpl(j2 ^ ULong.m167constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
