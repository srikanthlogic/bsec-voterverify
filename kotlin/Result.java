...
public final class Result<T> implements Serializable {
    ...
    public static boolean m14equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m22unboximpl());
    }
    ...
    public static Object m13constructorimpl(Object value) {
        return value;
    }

    /* renamed from: isSuccess-impl */
    public static final boolean m20isSuccessimpl(Object $this) {
        return !($this instanceof Failure);
    }

    /* renamed from: isFailure-impl */
    public static final boolean m19isFailureimpl(Object $this) {
        return $this instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl */
    private static final T m17getOrNullimpl(Object $this) {
        if (m19isFailureimpl($this)) {
            return null;
        }
        return $this;
    }
    ...
    public static final Throwable m16exceptionOrNullimpl(Object $this) {
    ...
    public static String m21toStringimpl(Object $this) {
        if ($this instanceof Failure) {
    ...
    /* compiled from: Result.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0004\b\u0001\u0010\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0087\bø\u0001\u0000¢\u0006\u0002\u0010\bJ%\u0010\t\u001a\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0004\b\u0001\u0010\u00052\u0006\u0010\n\u001a\u0002H\u0005H\u0087\bø\u0001\u0000¢\u0006\u0002\u0010\u000b\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\f"}, d2 = {"Lkotlin/Result$Companion;", "", "()V", "failure", "Lkotlin/Result;", ExifInterface.GPS_DIRECTION_TRUE, "exception", "", "(Ljava/lang/Throwable;)Ljava/lang/Object;", FirebaseAnalytics.Param.SUCCESS, "value", "(Ljava/lang/Object;)Ljava/lang/Object;", "kotlin-stdlib"}, k = 1, mv = {1, 1, 16})
    /* loaded from: classes3.dex */
    public static final class Companion {
        ...
        private final <T> Object success(T t) {
            return Result.m13constructorimpl(t);
        }
