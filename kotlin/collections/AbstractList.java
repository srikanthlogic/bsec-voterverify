...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    private static final class SubList<E> extends AbstractList<E> implements RandomAccess {
        ...
        public SubList(AbstractList<? extends E> abstractList, int fromIndex, int toIndex) {
    ...
    /* compiled from: AbstractList.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010(\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0003\b\u0092\u0004\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001B\u0005¢\u0006\u0002\u0010\u0002J\t\u0010\t\u001a\u00020\nH\u0096\u0002J\u000e\u0010\u000b\u001a\u00028\u0000H\u0096\u0002¢\u0006\u0002\u0010\fR\u001a\u0010\u0003\u001a\u00020\u0004X\u0084\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\b¨\u0006\r"}, d2 = {"Lkotlin/collections/AbstractList$IteratorImpl;", "", "(Lkotlin/collections/AbstractList;)V", FirebaseAnalytics.Param.INDEX, "", "getIndex", "()I", "setIndex", "(I)V", "hasNext", "", "next", "()Ljava/lang/Object;", "kotlin-stdlib"}, k = 1, mv = {1, 1, 16})
    /* loaded from: classes3.dex */
    ...
    private class ListIteratorImpl extends AbstractList<E>.IteratorImpl implements ListIterator<E>, KMappedMarker {
        ...
        public ListIteratorImpl(int index) {
            super();
            AbstractList.this = $outer;
            AbstractList.Companion.checkPositionIndex$kotlin_stdlib(index, $outer.size());
            setIndex(index);
        }
    ...
    public static final class Companion {
        ...
        public final boolean orderedEquals$kotlin_stdlib(Collection<?> collection, Collection<?> collection2) {
            ...
            Iterator<?> it = collection.iterator();
            while (it.hasNext()) {
                if (true ^ Intrinsics.areEqual(it.next(), otherIterator.next())) {
                    return false;
                }
            }
            return true;
