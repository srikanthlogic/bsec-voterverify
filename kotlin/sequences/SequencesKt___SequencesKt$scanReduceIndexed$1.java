...
@DebugMetadata(c = "kotlin.sequences.SequencesKt___SequencesKt$scanReduceIndexed$1", f = "_Sequences.kt", i = {0, 0, 0, 1, 1, 1, 1}, l = {1522, 1526}, m = "invokeSuspend", n = {"$this$sequence", "iterator", "accumulator", "$this$sequence", "iterator", "accumulator", FirebaseAnalytics.Param.INDEX}, s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2", "I$0"})
...
final class SequencesKt___SequencesKt$scanReduceIndexed$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super S>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ...
            iterator = this.$this_scanReduceIndexed.iterator();
            if (!iterator.hasNext()) {
                return Unit.INSTANCE;
            }
            Object accumulator2 = iterator.next();
            this.L$0 = $this$sequence;
            this.L$1 = iterator;
            this.L$2 = accumulator2;
            this.label = 1;
            if ($this$sequence.yield(accumulator2, this) == coroutine_suspended) {
            ...
            while (iterator.hasNext()) {
                ...
                Object accumulator4 = function3.invoke(Boxing.boxInt(index), accumulator, iterator.next());
                sequencesKt___SequencesKt$scanReduceIndexed$1.L$0 = $this$sequence;
                sequencesKt___SequencesKt$scanReduceIndexed$1.L$1 = iterator;
                sequencesKt___SequencesKt$scanReduceIndexed$1.L$2 = accumulator4;
                sequencesKt___SequencesKt$scanReduceIndexed$1.I$0 = index3;
                sequencesKt___SequencesKt$scanReduceIndexed$1.label = 2;
                if ($this$sequence.yield(accumulator4, sequencesKt___SequencesKt$scanReduceIndexed$1) == obj) {
                    return obj;
                }
