...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            Continuation completion = baseContinuationImpl.completion;
            if (completion == null) {
                Intrinsics.throwNpe();
            }
            try {
                outcome2 = baseContinuationImpl.invokeSuspend(param);
            } catch (Throwable exception) {
                Result.Companion companion = Result.Companion;
                outcome = Result.m13constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome2 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                Result.Companion companion2 = Result.Companion;
                outcome = Result.m13constructorimpl(outcome2);
