...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    private static final double min(double a2, double b) {
        return Math.min(a2, b);
    }

    private static final double max(double a2, double b) {
    ...
    private static final float min(float a2, float b) {
        return Math.min(a2, b);
    }

    private static final float max(float a2, float b) {
        return Math.max(a2, b);
    }
    ...
    private static final int min(int a2, int b) {
        return Math.min(a2, b);
    }

    private static final int max(int a2, int b) {
        return Math.max(a2, b);
    }
    ...
    private static final long min(long a2, long b) {
        return Math.min(a2, b);
    }

    private static final long max(long a2, long b) {
        return Math.max(a2, b);
    }
