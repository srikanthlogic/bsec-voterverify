...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        try {
            ...
            return Result.m13constructorimpl(createFailure(e));
        }
    }
    ...
    private static final <R, T extends R> R getOrElse(Object $this$getOrElse, Function1<? super Throwable, ? extends R> function1) {
        Throwable exception = Result.m16exceptionOrNullimpl($this$getOrElse);
        if (exception == null) {
            return $this$getOrElse;
        }
        return (R) function1.invoke(exception);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private static final <R, T extends R> R getOrDefault(Object $this$getOrDefault, R r) {
        if (Result.m19isFailureimpl($this$getOrDefault)) {
            return r;
        }
    ...
    private static final <R, T> R fold(Object $this$fold, Function1<? super T, ? extends R> function1, Function1<? super Throwable, ? extends R> function12) {
        Throwable exception = Result.m16exceptionOrNullimpl($this$fold);
        if (exception == null) {
            return (R) function1.invoke($this$fold);
        }
        return (R) function12.invoke(exception);
    }

    private static final <R, T> Object map(Object $this$map, Function1<? super T, ? extends R> function1) {
        if (!Result.m20isSuccessimpl($this$map)) {
            return Result.m13constructorimpl($this$map);
        }
        Result.Companion companion = Result.Companion;
        return Result.m13constructorimpl(function1.invoke($this$map));
    }

    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> function1) {
        if (!Result.m20isSuccessimpl($this$mapCatching)) {
            return Result.m13constructorimpl($this$mapCatching);
        }
        try {
            Result.Companion companion = Result.Companion;
            return Result.m13constructorimpl(function1.invoke($this$mapCatching));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
    ...
    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> function1) {
        Throwable exception = Result.m16exceptionOrNullimpl($this$recover);
        if (exception == null) {
            return $this$recover;
        }
        Result.Companion companion = Result.Companion;
        return Result.m13constructorimpl(function1.invoke(exception));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> function1) {
        Throwable exception = Result.m16exceptionOrNullimpl($this$recoverCatching);
        if (exception == null) {
    ...
    private static final <T> Object onFailure(Object $this$onFailure, Function1<? super Throwable, Unit> function1) {
        Throwable it = Result.m16exceptionOrNullimpl($this$onFailure);
        if (it != null) {
            function1.invoke(it);
        }
    ...
    private static final <T> Object onSuccess(Object $this$onSuccess, Function1<? super T, Unit> function1) {
        if (Result.m20isSuccessimpl($this$onSuccess)) {
