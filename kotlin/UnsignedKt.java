...
public final class UnsignedKt {
    ...
    public static final int m324uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m98constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* renamed from: uintRemainder-J1ME1BU */
    public static final int m325uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m98constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* renamed from: ulongDivide-eb3DHEI */
    public static final long m326ulongDivideeb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            ...
            return ULong.m167constructorimpl(v1 / v2);
        } else {
            int i = 1;
            long quotient = ((v1 >>> 1) / v2) << 1;
            if (ulongCompare(ULong.m167constructorimpl(v1 - (quotient * v2)), ULong.m167constructorimpl(v2)) < 0) {
                i = 0;
            }
            return ULong.m167constructorimpl(((long) i) + quotient);
        }
    }

    /* renamed from: ulongRemainder-eb3DHEI */
    public static final long m327ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
            if (ulongCompare(v1, v2) < 0) {
                return v1;
            ...
            if (ulongCompare(ULong.m167constructorimpl(rem), ULong.m167constructorimpl(v2)) >= 0) {
                j = v2;
            }
            return ULong.m167constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        if (!Double.isNaN(v) && v > uintToDouble(0)) {
            ...
            if (v <= d) {
                return UInt.m98constructorimpl((int) v);
            }
            return UInt.m98constructorimpl(UInt.m98constructorimpl((int) (v - d)) + UInt.m98constructorimpl(Integer.MAX_VALUE));
        }
        return 0;
    }
    ...
    public static final long doubleToULong(double v) {
        if (!Double.isNaN(v) && v > ulongToDouble(0)) {
            ...
            if (v < ((double) Long.MAX_VALUE)) {
                return ULong.m167constructorimpl((long) v);
            }
            return ULong.m167constructorimpl(ULong.m167constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
        }
        return 0;
    }
