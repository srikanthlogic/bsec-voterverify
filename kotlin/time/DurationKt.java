...
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m966constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m1011timesmvk6XK0(int $this$times, double duration) {
        return Duration.m993timesimpl(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk */
    private static final double m1010timeskIfJnKk(double $this$times, double duration) {
        return Duration.m992timesimpl(duration, $this$times);
    }
}
